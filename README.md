...
time to understand the [Statement of Work](https://github.com/xFusionTech/KMT/wiki/Statement-of-Work) in detail and 
...
During the course of our project, we have heavily relied on collaborative development and communication tools such as [GitHub](https://github.com/xFusionTech/KMT/) and [JIRA](https://github.com/xFusionTech/KMT/blob/master/ReadMe_EvidenceFiles/Scrum%20Process/JIRA%20Snapshots.pdf). The result of our efforts is a collaboratively designed and built Working Prototype that meets the MVP of the RFI requirements using modern, open source technologies within a smaller time frame.
